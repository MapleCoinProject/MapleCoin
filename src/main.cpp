...
// Copyright (c) 2011 The MapleCoin Developers
...
{
    // Maplecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Maplecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Maplecoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
unsigned char pchMessageStart[4] = { 0xf7, 0xc1, 0xb6, 0xdb }; // Maplecoin: increase each by adding 2 to bitcoin's value.
